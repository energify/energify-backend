...
describe("OrderMap", () => {
  ...
  const measurement: IMeasure[] = [
    { value: 40, userId: 1, date: new Date() },
    { value: 10, userId: 2, date: new Date() },
    { value: 20, userId: 3, date: new Date() },
    { value: -15, userId: 4, date: new Date() },
    { value: -10, userId: 5, date: new Date() },
    { value: 20, userId: 6, date: new Date() },
    { value: -5, userId: 7, date: new Date() },
    { value: -2.4, userId: 8, date: new Date() },
    { value: 4.8, userId: 9, date: new Date() },
    { value: 3, userId: 10, date: new Date() },
  ];

  it("", () => {
    const orderMap = new OrderMap(prices, measurement);
    console.log({ buyOrders: orderMap.buyOrders, sellOrders: orderMap.sellOrders });
    console.log(orderMap.match());
  });
});
